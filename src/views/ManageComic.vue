...
const handleChangeRadio = () => {
    if (control.value === 'manga') {
        mangaData.value = allData.value.filter((comic) => comic.category === 'Manga');
    } else if (control.value === 'manhua') {
        manhuaData.value = allData.value.filter((comic) => comic.category === 'Manhua');
    } else if (control.value === 'manhwa') {
        manhwaData.value = allData.value.filter((comic) => comic.category === 'Manhwa');
    }
};
