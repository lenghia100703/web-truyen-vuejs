    ...
    <el-header id="header">
        <div class="header-content">
            <el-menu class="menu" mode="horizontal" :ellipsis="false" background-color="#fff" menu-trigger="click">
                <el-menu-item class="no-hover" index="0" style="font-size: 20px; font-weight: 500">
                    ...
                    <el-dropdown>
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item
                                    ><router-link to="/truyen-da-dang">Truyện đã đăng</router-link> </el-dropdown-item
                                ><el-dropdown-item>
                ...
                <el-menu-item v-else class="no-hover">
                    <el-menu-item class="no-hover" index="5">
                        <el-button type="primary" plain><router-link to="/dang-ky">Đăng ký</router-link></el-button>
                    </el-menu-item>
                    <el-menu-item class="no-hover" index="6">
                        <el-button type="primary"><router-link to="/dang-nhap">Đăng nhập</router-link></el-button>
                    </el-menu-item>
                </el-menu-item>
            </el-menu>
        </div>
